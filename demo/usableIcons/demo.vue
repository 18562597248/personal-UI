<template>
    <div style="color: #262626;">
        <hd-row>
            <hd-col :cols="[8,12,12]">
                <hd-widget header-bordered-color-bottom="pink">
                    <span slot="title">FontAwesome Icons 4.0</span>
                    <div slot="body" class="row fontawesome-icon-list">
                    ...
                    <div slot="body" class="row fontawesome-icon-list margin-bottom-lg">
        ...
        <hd-row>
            <hd-col :cols="[8,12,12]">
                <hd-widget header-bordered-color-bottom="pink">
                    <span slot="title">Glyphicon Halflings</span>
                    <div slot="body" class="bs-glyphicons">
        ...
        <hd-row>
            <hd-col :cols="[8,12,12]">
                <hd-widget header-bordered-color-bottom="pink">
                    <span slot="title">Typicons</span>
                    <div slot="body" id="typicon-preview" class="clearfix">
                        <div class="icon">
        ...
        <hd-row>
            <hd-col :cols="[8,12,12]">
                <hd-widget header-bordered-color-bottom="pink">
                    <span slot="title">Weather Icons</span>
                    <div slot="body">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4>New in V1.2</h4>
        ...
        <hd-row>
            <hd-col :cols="[8,12,12]">
                <hd-widget header-bordered-color-bottom="pink">
                    <span slot="title">hd-icons</span>
                    <hd-row slot="body" class="fontawesome-icon-list">
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-plus"></hd-icon> hd-plus
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-trash"></hd-icon> hd-trash
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-pencil"></hd-icon> hd-pencil
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-search"></hd-icon> hd-search
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-floppy-disk"></hd-icon> hd-floppy-disk
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-th-list"></hd-icon> hd-th-list
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-remove"></hd-icon> hd-remove
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-share"></hd-icon> hd-share
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-repeat"></hd-icon> hd-repeat
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-fullscreen"></hd-icon> hd-fullscreen
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-resize-horizontal"></hd-icon> hd-resize-horizontal
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-arrow-left"></hd-icon> hd-arrow-left
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-arrow-right"></hd-icon> hd-arrow-right
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-save-add"></hd-icon> hd-save-add
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-question"></hd-icon> hd-question
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-ok"></hd-icon> hd-ok
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-remove-b"></hd-icon> hd-remove-b
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-inbox"></hd-icon> hd-inbox
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-print"></hd-icon> hd-print
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-check"></hd-icon> hd-check
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-paperclip"></hd-icon> hd-paperclip
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-log-in"></hd-icon> hd-log-in
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-new-window"></hd-icon> hd-new-window
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-angle-left"></hd-icon> hd-angle-left
                        </hd-col>
                        <hd-col :cols="[3,4,4]" class="fa-hover">
                            <hd-icon type="hd-icon hd-angle-right"></hd-icon> hd-angle-right
                        </hd-col>
                    </hd-row>
                </hd-widget>
            </hd-col>
...
<style>
    @font-face {
        ...
        src: url('../../static/fonts/weathericons-regular-webfont.eot');
        src: url('../../static/fonts/weathericons-regular-webfont.eot?#iefix') format('embedded-opentype'), url('../../static/fonts/weathericons-regular-webfont.woff') format('woff'), url('../../static/fonts/weathericons-regular-webfont.ttf') format('truetype'), url('../../static/fonts/weathericons-regular-webfont.svg#weathericons-regular-webfontRg') format('svg');
        font-weight: normal;
        font-style: normal;
    }
    .wi {
    ...
    .fontawesome-icon-list .fa-hover:hover .hd-icon ,
    ...
    .bs-glyphicons-list li:hover .glyphicon-class{
        vertical-align: 8px;
    }
    .weathericons:hover .icon .wi{
        font-size: 28px;
    }
    .weathericons:hover .class{
        margin-top: -5px;
        font-size: 12px;
    }
</style>