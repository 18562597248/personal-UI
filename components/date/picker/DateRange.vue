  ...
  <div :class="classes">
    <div class="datepicker daterange">
      ...
      <div :class="[prefixCls + '-body']" style="display: block">
        <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime" style="float:left">
          <div class="calendar-table" v-show="leftCurrentView !== 'time'">
            <table class="table-condensed" >
              <thead>
              <tr>
                <th    @click="prevYear('left')"><span><hd-icon type="fa fa-angle-double-left"></hd-icon></span></th>
                <th  @click="prevMonth" v-if="leftCurrentView === 'date'"><hd-icon type="fa  fa-angle-left"></hd-icon></th>
                <th @click.stop="showYearPicker('left')" style="padding-right: 0px;"><span>{{ leftYearLabel }}</span></th>
                <th @click.stop="showMonthPicker('left')"  v-if="leftCurrentView === 'date'" style="text-align: left;padding-left: 0px;"><span>{{ leftMonthLabel }}</span></th>
                <th @click="nextYear('left')" v-if="leftCurrentView === 'year' || leftCurrentView === 'month'"><span ><hd-icon type="fa fa-angle-double-right"></hd-icon></span></th>
              </tr>
              </thead>
            </table>
          </div>
        ...
        <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime" style="float:left">
          <div class="calendar-table"  v-show="rightCurrentView !== 'time'">
            <table class="table-condensed" >
              <thead>
              <tr>
                <th  @click="prevYear('right')"  v-show="rightCurrentView === 'year' || rightCurrentView === 'month'"><span><hd-icon type="fa fa-angle-double-left"></hd-icon></span></th>
                <th @click.stop="showYearPicker('right')" style="padding-right: 0px;"><span>{{ rightYearLabel }}</span></th>
                <th @click.stop="showMonthPicker('right')"  v-if="rightCurrentView === 'date'" style="text-align: left;padding-left: 0px;"><span>{{ rightMonthLabel }}</span></th>
                <th  @click="nextMonth" v-if="rightCurrentView === 'date'"><hd-icon type="fa  fa-angle-right"></hd-icon></th>
                <th @click="nextYear('right')"><hd-icon type="fa fa-angle-double-right"></hd-icon></span></th>
              </tr>
              </thead>
            </table>
          </div>
...
<script>
    ...
    import { toDate, prevMonth, nextMonth, initTimeDate } from '../utils/util';
